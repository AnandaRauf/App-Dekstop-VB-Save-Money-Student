...
Public Class Register
    Private Sub RegBut_Click(sender As Object, e As EventArgs) Handles RegBut.Click
        ...
        Try
            ...
            con.ConnectionString = ("Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Penting\Db SQL Server Project App Desktop\db_bank_schooll.mdf;Integrated Security=True;Connect Timeout=30")
            cmd.Connection = con
            con.Open()
