...
Module SQL_Server_Connect

    Public koneksiSQL As SqlConnection

    Sub konekdatabase()
        Try
            koneksiSQL = New SqlConnection("Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Penting\Db SQL Server Project App Desktop\db_bank_schooll.mdf;Integrated Security=True;Connect Timeout=30")
            koneksiSQL.Open()
